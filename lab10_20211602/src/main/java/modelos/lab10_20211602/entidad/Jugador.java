...
public class Jugador {
    ...
    public Jugador(int idJugador, String nombre, int edad, String posicion, String club, int sn_idSeleccion, String nombreSeleccion) {
    ...
    public void setNombreSeleccion(String nombreSeleccion) { this.nombreSeleccion = nombreSeleccion; }
}
